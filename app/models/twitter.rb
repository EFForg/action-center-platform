class Twitter
  def self.has_api_keys?
    !Rails.application.secrets.twitter_api_key.blank? && !Rails.application.secrets.twitter_api_secret.blank? && !Rails.application.secrets.twitter_oauth_token.blank? && !Rails.application.secrets.twitter_oauth_token_secret.blank?
  end
